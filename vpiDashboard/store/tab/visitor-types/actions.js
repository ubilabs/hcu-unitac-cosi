...
const actions = {
    ...
    getVisitorTypes: async ({state, commit}) => {
        ...
        const url = `${Config.whatalocationApi.host}${Config.whatalocationApi.basepath}/visitor-types/?group_by[date]=&location_id=${state.selectedLocationId}&group_by[VisitorType]&format=agg&aggregate[Avg]=num_visitors&pulse=activate&interval=300&transportation=pedestrian`,
