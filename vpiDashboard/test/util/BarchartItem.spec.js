...
describe("src/share-components/charts/components/BarchartItem.vue", () => {
    ...
    beforeEach(() => {
        wrapper = shallowMount(BarchartItem, {
            propsData: {
                ...
                givenOptions: {},
                givenScales: givenScaleParameters
            },
            localVue
        });
    });
    ...
    describe("getChartJsOptions", () => {
        ...
        it("should deep assign the given options", () => {
            const objA = {
                    test: {
                        a: 1,
                        b: 2
        ...
        it("should deep assign the given scale parameters", () => {

            wrapper.vm.resetChart({});

            expect(wrapper.vm.defaultOptions.scales).to.deep.equal(givenScaleParameters);
        });
    });
});
