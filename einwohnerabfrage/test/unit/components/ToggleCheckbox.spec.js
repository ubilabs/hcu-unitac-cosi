...
describe("addons/EinwohnerAbfrage2/components/ToggleCheckbox.vue", () => {
    it("should have the correct Labels and correct active class for active state", () => {
        ...
        expect(labelTags.at(0).text()).to.be.equal("common:snippets.checkbox.on");
        expect(labelTags.at(1).text()).to.be.equal("common:snippets.checkbox.off");
