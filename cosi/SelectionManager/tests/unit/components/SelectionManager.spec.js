...
describe("addons/cosi/SelectionManager/components/SelectionManager.vue", () => {
    let vuetify, store;

    const dashboardOpen = false,
        selectionGroups = ["Gebietsauswahl", "Erreichbarkeitsanalyse"],
        activeLayerList = ["Öffentliche Schulen", "Coronatestzentren", "Krankenhäuser"];
     ...
     * @returns 
     */
    function getMount (values = {}, isActive = true) {
        return shallowMount(SelectionManager, {
            store,
            localVue,
            vuetify,
            data () {
            ...
            computed: {
                ...
                additionalInfoLayers: () => activeLayerList
            },
            methods: {
        ...
        store = new Vuex.Store({
            ...
            modules: {
                Tools: {
                    namespaced: true,
                    modules: {
                        SelectionManager: SelectionManagerStore
                    }
                },
                Maps: {
                    namespaced: true,
