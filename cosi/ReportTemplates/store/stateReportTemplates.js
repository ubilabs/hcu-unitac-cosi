...
export default {
    ...
    templateItems: [ // the current template. It is always an array, each item a chapter with this general structure (see ../docs/ for details)
        {title: "", description: "", tool: "Dashboard", settings: {}, hasSettings: false, output: {}, hasOutput: false, includeDataSelection: false, dataSelection: {}, hasDataSelection: false, id: 0}
    ],
    readmeUrl: {
