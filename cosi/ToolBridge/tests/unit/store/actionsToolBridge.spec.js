...
// import importedState from "../../../store/stateToolBridge";
...
// describe("addons/ToolBridge/store/actionsToolBridge.js", () => {
...
//                     content: i18next.t("additional:modules.tools.ToolBridge.alertingMessages.success", {filename: payload.filename})},
//                 dispatch: true
//             }], {}, done);
//         });
...
//                     content: i18next.t("additional:modules.tools.ToolBridge.alertingMessages.missingFormat")
//                 },
//                 dispatch: true
//             }], {}, done);
//         });
...
//                 payload: {
//                     category: i18next.t("common:modules.alerting.categories.error"),
//                     content: i18next.t("additional:modules.tools.ToolBridge.alertingMessages.missingFileContent")
//                 },
//                 dispatch: true
//             }], {}, done);
//         });
