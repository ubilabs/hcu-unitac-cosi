...
import BildungsatlasSchulenEinzugsgebiete from "../../../components/BildungsatlasSchulenEinzugsgebiete.vue";

const localVue = createLocalVue();

localVue.use(Vuex);

describe("addons/components/BildungsatlasSchulenEinzugsgebiete.vue", () => {
    let wrapper;
