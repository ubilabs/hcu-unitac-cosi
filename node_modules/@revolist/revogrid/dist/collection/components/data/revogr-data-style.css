...
revogr-data .row.groupingRow {
  font-weight: 600;
}
revogr-data .row.groupingRow .group-expand {
  width: 25px;
  height: 100%;
  max-height: 25px;
  margin-right: 2px;
...
revogr-data .row.groupingRow .group-expand svg {
  width: 7px;
}
...
revogr-data .data-cell.align-center {
  text-align: center;
}
revogr-data .data-cell.align-left {
  text-align: left;
}
revogr-data .data-cell.align-right {
  text-align: right;
}