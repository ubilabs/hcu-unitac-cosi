import { h, r as registerInstance, c as createEvent, H as Host } from './index-5406b3af.js';
import { i as isFilterBtn } from './filter.button-a9f2bd58.js';
...
const FilterPanel = class {
  ...
  render() {
    ...
    return (h(Host, { style: style }, h("label", null, "Filter by condition"), h("select", { class: "select-css", onChange: e => this.onFilterChange(e) }, this.renderConditions(this.changes.type)), h("div", null, this.renderExtra(this.filterEntities[this.changes.type].extra, this.changes.value)), h(RevoButton, { class: { green: true }, onClick: () => this.onSave() }, "Save"), h(RevoButton, { class: { light: true }, onClick: () => this.onCancel() }, "Cancel")));
  }
  onFilterChange(e) {
    if (!this.changes) {
